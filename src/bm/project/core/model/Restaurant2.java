...
public class Restaurant2{
    static ArrayList<Menu> menuList2 = new ArrayList<>();
    ...
    private void setMenu() {   //해당 클래스에서만 접근이 가능
        menuList2.add(new Menu("참치샌드위치", 6000, menuList2));
        menuList2.add(new Menu("계란샌드위치", 5000, menuList2));
        menuList2.add(new Menu("야채샌드위치", 4500, menuList2));
        menuList2.add(new Menu("닭가슴살샌드위치", 5000, menuList2));
    }

    public List<Menu> getMenu() { return menuList2; }
